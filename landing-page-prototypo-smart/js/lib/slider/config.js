$(document).ready(function(){
  ...
  $('.video-slider').slick({
    ...
    prevArrow: '<div class="slick-prev radius-prev"><img class="radius-prev" src="images/iconosCS2/prev.svg"/></div>',
    nextArrow: '<div class="slick-next radius-next"><img class="radius-next" src="images/iconosCS2/next.svg"/></div>'
